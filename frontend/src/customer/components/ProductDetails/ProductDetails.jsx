    ...
    return (
        ...
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gay-y-10 pt-10 px-4'>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex flex-wrap space-x-5 justify-center">
                            {product.images.map((item) =>
                                <div className='aspect-h-2 aspect-w-2 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4'>
                                    <img
                                        alt={item.alt}
                                        src={item.src}
                                        className="h-full w-full object-cover object-center"
        ...
        lg:pb-24">
                        <div className="lg:col-span-2 ">
                            ...
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>6 Casual Tshirt for Men</h1>
                        </div>
                        {/* Options */}
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className='flex-items-center space x-3'>
                                    ...
                                    <p className='opacity-50 text-sm'>59439 Ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indifo-500'>3984 Reviews</p>
                                </div>
                            </div>
